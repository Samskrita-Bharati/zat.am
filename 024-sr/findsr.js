...
function sV(obj) {
obj.href+="&s="+getQueryStringValue("s");
...
$("#lead2").append("१.१.");
$("#lead2").append(String.fromCharCode(0x0966 + parseInt(String(sr).charAt(0))));
if (sr >= 10)
	$("#lead2").append(String.fromCharCode(0x0966 + parseInt(String(sr).charAt(1))));
if (sr == 100)
	$("#lead2").append(String.fromCharCode(0x0966 + parseInt(String(sr).charAt(2))));
