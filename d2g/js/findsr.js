...
var ch = getQueryStringValue("ch");
if (ch && parseInt(ch) >= 1 && parseInt(ch) <= 18) {
}
else
...
function sV(obj) {
obj.href+="&ch="+getQueryStringValue("ch")+"&v="+getQueryStringValue("v")+"&ss="+getQueryStringValue("ss");
