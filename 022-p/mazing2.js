...
var myfn = function(e) {
  var tryPos = new Position(MazeGame.heroPos.x, MazeGame.heroPos.y);
  switch(e)
  {
    case 'l': // left
      MazeGame.mazeContainer.classList.remove("face-right");
      tryPos.y--;
      break;
    ...
    case 'r': // right
      MazeGame.mazeContainer.classList.add("face-right");
      tryPos.y++;
      break;
