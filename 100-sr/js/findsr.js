...
var v = getQueryStringValue("v");
if (!v || isNaN(v))
	v=1;
var ss = parseInt(getQueryStringValue("ss"));
...
function sV(obj) {
obj.href+="&v="+getQueryStringValue("v")+"&ss="+getQueryStringValue("ss");
//window.location = window.location.origin + window.location.pathname + "?size=" + size +  "&v=" + verse_btn.innerText;
}
var t = parseInt(v)-1;
if (isNaN(ss) || ss<0 || ss>100) ss =0;
var wordList = s[t].s.split(" ");
...
$("#lead2").append(String.fromCharCode(0x0966 + parseInt(String(v).charAt(2))));
function showHint2()
{
$("#lead2").html("");
for (var i=0;i<wordList.length;i++)
