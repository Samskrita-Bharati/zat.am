...
var databaseBc308eec = require('./database-bc308eec-5055cc8a.js');
...
function loadBundle(data) {
    return databaseBc308eec.loadBundle(this._delegate, data);
}
function namedQuery(queryName) {
    return databaseBc308eec.namedQuery(this._delegate, queryName).then(expQuery => {
        if (!expQuery) {
            return null;
        }
        return new databaseBc308eec.Query$1(this, 
...
registerBundle(databaseBc308eec.Firestore);
