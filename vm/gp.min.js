...
(function () {
    ...
    function n(a, b, c) {
        ...
        else if (window.external && "notify" in window.external) window.external.notify(JSON.stringify({ eventType: a, eventData: c })), b();
        else if (k)
            try {
...
//debugger;
        var b = 500 >= l(1, 1e3);
        hard = 30 < u;
        //a = ["+", "\u2013", "\u00d7", "/"][a];    // hht - 6aug2026 - just add or subtract
a = ["+", "\u2013","+", "\u2013"][a];
        switch (a) {
            case "+":
            case "\u2013":
            ...
            case "\u00d7":
            case "/":
                "\u00d7" == a ? ((c = l(hard ? 3 : 1, hard ? 20 : 10)), (d = l(hard ? 3 : 1, hard ? 20 : 10)), (f = c * d)) : ((f = l(hard ? 3 : 1, hard ? 20 : 10)), (d = l(hard ? 3 : 1, hard ? 20 : 10)), (c = f * d)),
    ...
    function H() {
        var a = +u || "0";
        ha.innerHTML = Sanscript.t(String(a),'iast', 'iast');
        ia.innerHTML = Sanscript.t(String(a),'iast', 'iast');
    }
    function I() {
		//debugger;
		...
		m && ((ja.innerHTML = Sanscript.t(String(m.x),'iast', 'iast') ), (ka.innerHTML = Sanscript.t(String(m.op),'iast', 'iast') ), (la.innerHTML = Sanscript.t(String(m.y),'iast', 'iast')), (ma.innerHTML = Sanscript.t(String(m.res),'iast', 'iast') ));
    }
    function na() {
        clearTimeout(X);
        t(Y, "tossing");
    ...
    function pa() {
        q &&
            da("/api/setScore", { data: q, score: u || 0 }, function (a) {
                h = a.scores;
                aa();
                K();
    ...
    function ea() {
        q &&
            da("/api/getHighScores", { data: q }, function (a) {
                h = a.scores;
                aa();
                K();
            });
