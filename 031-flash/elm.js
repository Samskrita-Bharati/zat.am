...
{
	if (region.R.E === region._.E)
	{
		return 'on line ' + region.R.E;
	}
	return 'on lines ' + region.R.E + ' through ' + region._.E;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {ad: fragment, ag: host, ao: path, aq: port_, au: protocol, av: query};
	});
																...
																return function (scriptHeading) {
																	return function (mainPartFontSize) {
																		return function (allSubjects) {
																			return {aM: allSubjects, aT: copyrightNotice, aU: deckId, aV: deckTitle, a2: initialScript, J: landingPage, a4: mainPartFontSize, a6: numChoices, ba: pluralSubjectName, bg: scriptCanBeSet, bh: scriptHeading, bj: showAudio, bk: showAudioWithLocalNameQuiz, bl: showAudioWithUrNameQuiz, bm: showDescription, bn: showDescriptionWithLocalNameQuiz, bo: showDescriptionWithUrNameQuiz, bu: trainModeDisplay, bv: trainingModes};
																		};
																	};
																};
															};
...
var $author$project$Types$Subject = F7(
	function (subjectId, imageUrl, audioUrl, unicode, latin, localName, description) {
		return {D: audioUrl, K: description, a_: imageUrl, M: latin, al: localName, aD: subjectId, T: unicode};
	});
...
var $author$project$Types$invalidSubject = A7($author$project$Types$Subject, -1, $elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing, 'invalid', 'invalid', 'invalid', 'invalid');
...
var $author$project$Types$defaultConfig = $author$project$Types$Config('invalid deck')('invalid deck')($elm$core$Maybe$Nothing)(0)(true)(true)(true)(true)(true)(true)(true)(_List_Nil)('')('')(0)($elm$core$Dict$empty)('')($elm$core$Maybe$Nothing)($author$project$Types$invalidSubjectList);
var $author$project$Types$emptyCard = {aQ: _List_Nil, bp: $author$project$Types$invalidSubject};
...
var $author$project$Config$defaultModel = {
	aR: $author$project$Types$defaultConfig,
	a0: true,
	bb: _List_Nil,
	bc: $author$project$Types$invalidCards,
	be: 0,
	bi: {bf: 0, bt: 0},
	bj: true,
	bs: 0,
...
var $author$project$Main$initialModel = function (cfg) {
	var mdl = $author$project$Config$defaultModel;
...
var $author$project$Card$generateChoices = F3(
	function (numChoices, allSubjects, correctSubject) {
		var wrongSubjects = A3(
			...
			function (a) {
				return !_Utils_eq(a.aD, correctSubject.aD);
			},
...
var $author$project$Main$initWithModel = function (model) {
	return _Utils_Tuple2(
		model,
		A2(
			$elm$random$Random$generate,
			$author$project$Types$Shuffle,
			A2($author$project$Card$generateDeck, model.aR.a6, model.aR.aM)));
};
var $author$project$Main$processSelectedDeck = function (model) {
	var sttgs = model.bi;
	...
	return $author$project$Main$initWithModel(newModel);
};
var $author$project$Main$init = function (configValue) {
	var mdl = $author$project$Main$initialModel(
		function () {
	...
	return $author$project$Main$processSelectedDeck(mdl);
};
var $author$project$Types$MouseClick = {$: 11};
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				$elm$json$Json$Decode$succeed($author$project$Types$MouseClick))
			]));
};
var $author$project$Types$Next = {$: 0};
var $author$project$Types$Settings = F2(
	function (trainMode, script) {
		return {bf: script, bt: trainMode};
	});
var $author$project$Types$ShowAudio = {$: 2};
var $author$project$Types$Start = {$: 5};
...
var $author$project$Main$getAnswer = function (_v0) {
	var trainMode = _v0.bt;
	var script = _v0.bf;
	switch (trainMode) {
		case 0:
			return $elm$core$Basics$always('N/A');
		case 1:
...
var $author$project$Main$nextEnabled = function (model) {
	var notEnd = !$mgold$elm_nonempty_list$List$Nonempty$isSingleton(model.bc);
	var inReview = !model.bi.bt;
	var answered = $elm_community$maybe_extra$Maybe$Extra$isJust(model.bx);
	return (!model.a0) && (notEnd && (inReview || answered));
};
...
var $author$project$Main$update = F2(
	function (msg, model) {
		var prevCard = A2(
			...
			$elm$core$List$head(model.bb));
		var nextCard = $mgold$elm_nonempty_list$List$Nonempty$head(model.bc);
		var hasAudio = function (subj) {
			return $elm_community$maybe_extra$Maybe$Extra$isJust(subj.D);
		};
			...
			switch (msg.$) {
						...
						model,
						{
							be: _Utils_eq(
								...
								A2(
									...
									model.bi,
									$mgold$elm_nonempty_list$List$Nonempty$head(model.bc).bp)) ? (model.be + 1) : model.be,
							bs: model.bs + 1,
							bx: $elm$core$Maybe$Just(str)
						});
				case 5:
					return _Utils_update(
						model,
				...
				case 0:
					return _Utils_update(
						model,
						{
							bb: A2($elm$core$List$cons, nextCard, model.bb),
							bc: $mgold$elm_nonempty_list$List$Nonempty$pop(model.bc),
							bj: !hasAudio(
								$mgold$elm_nonempty_list$List$Nonempty$head(model.bc).bp),
							bx: $elm$core$Maybe$Nothing
						});
				case 1:
					var remaining = A2($mgold$elm_nonempty_list$List$Nonempty$cons, prevCard, model.bc);
					var newPrevDeck = A2($elm$core$List$drop, 1, model.bb);
					return _Utils_update(
						model,
						{
							bb: newPrevDeck,
							bc: remaining,
							bj: !hasAudio(prevCard.bp)
						});
				default:
					return model;
			}
		}();
		var nextKeyPressed = function (_v3) {
			return newModel.a0 ? A2($author$project$Main$update, $author$project$Types$Start, newModel) : ($author$project$Main$nextEnabled(model) ? A2($author$project$Main$update, $author$project$Types$Next, newModel) : _Utils_Tuple2(newModel, $elm$core$Platform$Cmd$none));
		};
		var sleepThenShowAudio = function (subj) {
			return hasAudio(subj) ? A2(
		...
		while (true) {
			switch (msg.$) {
				...
				case 0:
					return _Utils_Tuple2(
						newModel,
						sleepThenShowAudio(nextCard.bp));
				case 1:
					return _Utils_Tuple2(
						newModel,
						sleepThenShowAudio(prevCard.bp));
				case 13:
					return _Utils_Tuple2(
						newModel,
						function () {
...
var $author$project$Types$GoLanding = {$: 13};
var $author$project$Types$Previous = {$: 1};
var $author$project$Types$Reset = {$: 6};
...
var $author$project$Main$playAudio = F2(
...
var $author$project$Main$showDescriptionInCard = F2(
	function (model, card) {
		var descriptionHtml = function (subject) {
			return $elm$core$String$isEmpty(subject.K) ? _List_Nil : _List_fromArray(
				[
					A2(
					$elm$html$Html$p,
					_List_fromArray(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('\"' + (subject.K + '\"'))
						]))
				]);
		};
		return model.aR.bm ? _List_fromArray(
			[
				A2(
				$elm$html$Html$tr,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('minorPart descriptionBlock')
					]),
				descriptionHtml(card.bp))
			]) : _List_Nil;
	});
...
var $author$project$Config$showTrainMode = F2(
	function (cfg, trainMode) {
		...
		return A2(
			$elm$core$Maybe$withDefault,
			'invalid',
			A2($elm$core$Dict$get, modeAsString, cfg.bu));
	});
...
var $author$project$Main$viewImage = function (maybeUrl) {
	if (!maybeUrl.$) {
		var url = maybeUrl.a;
		return _List_fromArray(
			[
...
var $author$project$Main$viewLocalName = function (subject) {
	return A2(
		$elm$html$Html$p,
		_List_Nil,
		_List_fromArray(
			[
				$elm$html$Html$text(subject.al)
			]));
};
...
var $author$project$Main$viewQuiz = F3(
	function (legendLabel, model, card) {
		var isDisabled = $elm_community$maybe_extra$Maybe$Extra$isJust(model.bx);
		var isCorrect = function (val) {
			return _Utils_eq(
				A2($author$project$Main$getAnswer, model.bi, card.bp),
				val);
		};
		...
		var labelAttributes = function (val) {
			return _Utils_ap(
				(model.bi.bt === 3) ? _List_fromArray(
					[
						$elm$html$Html$Attributes$class('italic')
					]) : _List_Nil,
				isDisabled ? (isCorrect(val) ? correctAttributes : incorrectAttributes) : _List_Nil);
		};
		var toInputView = F2(
			function (i, val) {
				return A2(
					...
					_List_fromArray(
						[
								...
								[
									...
									_List_fromArray(
										[
											...
											$elm$html$Html$Attributes$placeholder(val),
							...
							A2(
								$elm$core$List$cons,
								$elm$html$Html$Attributes$class('quiz'),
								(isDisabled && isCorrect(val)) ? correctAttributes : _List_Nil),
							_List_fromArray(
								[
									A2(
									$elm$html$Html$label,
		...
		var getChoices = A2(
			...
			$elm_community$list_extra$List$Extra$unique(
				A2(
					$elm$core$List$map,
					$author$project$Main$getAnswer(model.bi),
					card.aQ)));
		return A2(
			$elm$html$Html$div,
			(model.bi.bt === 3) ? _List_fromArray(
				[
					$elm$html$Html$Attributes$class('descriptionQuiz')
				]) : _List_Nil,
			_List_fromArray(
				[
					A2(
...
var $author$project$Main$viewScore = function (model) {
	var remaining = $mgold$elm_nonempty_list$List$Nonempty$length(model.bc);
	var percentValue = A3(
		$elm$core$Basics$composeL,
		$elm$core$String$fromInt,
		$elm$core$Basics$round,
		(!model.bs) ? 0.0 : ((100 * model.be) / model.bs));
	var percentString = ' ( ' + (percentValue + '%)');
	var scoreView = (!model.bi.bt) ? _List_Nil : _List_fromArray(
		[
			$elm$html$Html$text(
			'Score: ' + ($elm$core$String$fromInt(model.be) + ('/' + ($elm$core$String$fromInt(model.bs) + percentString)))),
			A2($elm$html$Html$br, _List_Nil, _List_Nil)
		]);
	return A2(
		$elm$html$Html$h3,
		...
		_Utils_ap(
			scoreView,
			(remaining > 0) ? _List_fromArray(
				[
					$elm$html$Html$text(
					'Number of ' + (model.aR.ba + (' Remaining: ' + $elm$core$String$fromInt(remaining - 1))))
				]) : _List_Nil));
};
var $elm$html$Html$Attributes$title = $elm$html$Html$Attributes$stringProperty('title');
var $author$project$Main$viewUrname = F2(
	function (subject, settings) {
		var _v0 = settings.bf;
		if (!_v0) {
			return A2(
				$elm$html$Html$p,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$title(subject.T)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(subject.M)
					]));
		} else {
			return A2(
				$elm$html$Html$p,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$title(subject.M)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(subject.T)
					]));
		}
	});
var $author$project$Main$viewCard = F2(
	function (model, card) {
		return A2(
			...
			_List_Nil,
			_Utils_ap(
				$author$project$Main$viewImage(card.bp.a_),
				_List_fromArray(
					[
						A2(
						$elm$html$Html$div,
						...
						function () {
							var startOver = A2(
								...
								$elm_community$maybe_extra$Maybe$Extra$isJust(model.aR.J) ? _List_fromArray(
									[
										A2(
										$elm$html$Html$button,
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('button end-button'),
							...
							var prevEnabled = (!model.bi.bt) && (!$elm$core$List$isEmpty(model.bb));
												...
												_Utils_ap(
													_List_fromArray(
														[
															...
															_List_fromArray(
																[
																	A2($author$project$Main$viewUrname, card.bp, model.bi)
																])),
															A2(
															$elm$html$Html$tr,
															_List_fromArray(
															...
															_List_fromArray(
																[
																	$author$project$Main$viewLocalName(card.bp)
																]))
														]),
													_Utils_ap(
														A2($author$project$Main$showDescriptionInCard, model, card),
														A2($author$project$Main$playAudio, model, card.bp.D)))),
												A2($elm$html$Html$hr, _List_Nil, _List_Nil)
											]);
									case 1:
										var descriptionHtml = model.aR.bo ? A2($author$project$Main$showDescriptionInCard, model, card) : _List_Nil;
										var audioHtml = model.aR.bl ? A2($author$project$Main$playAudio, model, card.bp.D) : _List_Nil;
										return _List_fromArray(
											[
												A2(
												$elm$html$Html$table,
												...
												A3(
												$author$project$Main$viewQuiz,
												A2($author$project$Config$showTrainMode, model.aR, 1),
												model,
												card)
											]);
									case 2:
										var descriptionHtml = model.aR.bn ? A2($author$project$Main$showDescriptionInCard, model, card) : _List_Nil;
										var audioHtml = model.aR.bk ? A2($author$project$Main$playAudio, model, card.bp.D) : _List_Nil;
										return _List_fromArray(
											[
												A2(
												$elm$html$Html$table,
							...
							var buttonStyle = function (isEnabled) {
								return isEnabled ? 'button' : 'disabledButton';
							};
							var nextButton = A2(
								$elm$html$Html$button,
								_List_fromArray(
									[
										...
										buttonStyle(
											$author$project$Main$nextEnabled(model))),
							...
							var allFinished = A2(
								...
								A2(
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('end-button'),
											$elm$html$Html$Events$onClick($author$project$Types$Reset)
										]),
									_List_fromArray(
										[
							...
							var endButtons = A2(
								...
								(!model.bi.bt) ? _Utils_ap(
									...
									allFinished) : ($elm_community$maybe_extra$Maybe$Extra$isJust(model.bx) ? _Utils_ap(
									_List_fromArray(
										[
											nextButton,
											A2($elm$html$Html$br, _List_Nil, _List_Nil),
							...
							return _Utils_ap(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$mgold$elm_nonempty_list$List$Nonempty$isSingleton(model.bc) ? endButtons : A2(
												$elm$html$Html$div,
												_List_fromArray(
													[
														$elm$html$Html$Attributes$id('buttons')
...
var $author$project$Main$radioScriptLabelHtml = function (script) {
	if (script === 1) {
		return _List_fromArray(
			[
...
var $author$project$Main$scriptFieldSet = function (model) {
	return A2(
		$elm$html$Html$fieldset,
		_List_Nil,
		_List_fromArray(
									...
									[
										...
										_List_fromArray(
											[
												...
												$elm$html$Html$Attributes$checked(model.bi.bf === 1)
											]),
										_List_Nil)
									])),
								A2(
...
var $author$project$Main$trainModeFieldSet = function (model) {
		...
		[
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$Attributes$checked(model.bi.bt === 1)
				]),
			_List_Nil),
			A2(
			$elm$html$Html$label,
		...
		[
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$Events$onInput($author$project$Types$SetTrainMode),
					$elm$html$Html$Attributes$checked(!model.bi.bt)
				]),
			_List_Nil),
			A2(
			$elm$html$Html$label,
		...
		[
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$Events$onInput($author$project$Types$SetTrainMode),
					$elm$html$Html$Attributes$checked(model.bi.bt === 2)
				]),
			_List_Nil),
			A2(
			$elm$html$Html$label,
	...
	var filterConfig = F2(
		function (trainMode, htmlElements) {
			return A2($elm$core$List$member, trainMode, model.aR.bv) ? htmlElements : _List_Nil;
		});
		...
		[
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$Events$onInput($author$project$Types$SetTrainMode),
					$elm$html$Html$Attributes$checked(model.bi.bt === 3)
				]),
			_List_Nil),
			A2(
			$elm$html$Html$label,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(model.aR.aV)
					])),
				A2(
				$elm$html$Html$h2,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						A2(
							$elm$core$List$cons,
							$author$project$Main$trainModeFieldSet(model),
							A2(
								$elm$core$List$cons,
								A2($elm$html$Html$br, _List_Nil, _List_Nil),
								model.aR.bg ? _List_fromArray(
									[
										$author$project$Main$scriptFieldSet(model)
									]) : _List_Nil))),
						A2($elm$html$Html$br, _List_Nil, _List_Nil),
						A2(
						$elm$html$Html$div,
						...
						A2(
							...
							A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('button startButton'),
							...
							$elm_community$maybe_extra$Maybe$Extra$isJust(model.aR.J) ? _List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('button startButton end-button'),
											$elm$html$Html$Events$onClick($author$project$Types$GoLanding)
										]),
									_List_fromArray(
										[
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				model.a0 ? $author$project$Main$viewSettings(model) : A2(
				$author$project$Main$viewCard,
				model,
				$mgold$elm_nonempty_list$List$Nonempty$head(model.bc)),
				A2(
				$elm$html$Html$p,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(model.aR.aT)
					]))
			]));
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{a1: $author$project$Main$init, bq: $author$project$Main$subscriptions, bw: $author$project$Main$update, by: $author$project$Main$view});
