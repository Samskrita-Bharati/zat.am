...
{
	$("#cap").append("<span class=nob title='"+Sanscript.t(wordList[i], 'devanagari','iast')+"'>"+wordList[i]+" </span>");
}
idx= vCount.findIndex(checkAge);
$("#cap").append("। #" + t + " == " + idx + ":" + parseInt(-1*(vCount[idx-1]-t)));
};
