...
var emls = ["toronto@samskritabharatiusa.org",
    ...
    "artik@samskritabharatiusa.org", 
    "aniketk@samskritabharatiusa.org",
    "vi.raama@gmail.com",
    "amrutputra@gmail.com",
    "samskritam@gmail.com",
    "nalinyvasan@gmail.com",
    "subramaniann@samskritabharatiusa.org", 
    "radhiradhi@gmail.com",
    "madhureemaa@gmail.com"
];
...
function showit() {
    ...
    if (yr == 1998)
        $("#if iframe")[0].src = "https://app.amuselabs.com/app/date-picker?set=" + "sanskritbharatiusa-pa%20199&embed=1";
    else
        $("#if iframe")[0].src = "https://app.amuselabs.com/app/date-picker?set=" + "sanskritbharatiusa-pa" + yr + "&embed=1";
}
